...
public class Main {
    ...
    public static void main(String[] args) {
        nombreMayerlySuarez();
        nombreAlejandroJaramilloRodriguez();
        nombreJoseAlejandroJimenez();
        nombreMariaAlejandraOcampo();
        simonMartinez();
        crearMascota();
        consultarMascotas();
        imprimirMiNombre();
        ...
        imprimirNombreCesarMontoya();
        nombreJuanCamiloRamon();
        thomasBuitrago();
        juanSebastianRave();
    }
    ...
    static void nombreMayerlySuarez() {
        System.out.println("Estudiante: Mayerly Alejandra Suarez Sepulveda");
    }
    ...
    static void nombreAlejandroJaramilloRodriguez() {
    ...
    static void nombreJoseAlejandroJimenez() {
    ...
    static void nombreMariaAlejandraOcampo() {
